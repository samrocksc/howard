$_mod.def("/fetch-mock$5.12.2/es5/compile-route", function(require, exports, module, __filename, __dirname) { 'use strict';

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _glob = require('/glob-to-regexp$0.3.0/index'/*'glob-to-regexp'*/);
var _express = require('/path-to-regexp$1.7.0/index'/*'path-to-regexp'*/);
